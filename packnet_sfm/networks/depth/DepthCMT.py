...
from packnet_sfm.networks.depth.cmt import CMT, CMT_Ti, CMT_B
...
class DepthCMT(nn.Module):
    def __init__(self, version=None, 
        ...
        self.cmt = CMT_Ti(in_channels = 3, input_size = 256, embed_dim= embed_dim)
        #self.cmt = CMT_B(in_channels = 3, input_size = 256, embed_dim= embed_dim)
    ...
    def forward(self, x):
        ...
        #outs = [self.scale_inv_depth(self.sigmoid(fc_outs[i]))[0] for i in range(used_backbone_levels)]
