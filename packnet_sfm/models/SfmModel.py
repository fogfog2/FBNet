...
class SfmModel(nn.Module):
    ...
    def compute_inv_depths2(self, image, depth):
        """Computes inverse depth maps from single images"""
    ...
    def forward(self, batch, return_logs=False):
        ...
        #2
        # Generate inverse depth predictions
        #inv_depths = self.compute_inv_depths(batch['rgb_context'][0])
        #inv_depths = self.compute_inv_depths2(batch['rgb'],inv_depths[0])
