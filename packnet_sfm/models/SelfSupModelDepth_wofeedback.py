...
from packnet_sfm.models.SfmModel_depth_wofeedback import SfmModel_depth_wofeedback
from packnet_sfm.losses.multiview_photometric_loss import MultiViewPhotometricLoss
from packnet_sfm.losses.multiview_photometric_loss_remap import MultiViewPhotometricLossRemap
from packnet_sfm.losses.multiview_photometric_loss_cross_remap import MultiViewPhotometricLossCrossRemap
from packnet_sfm.models.model_utils import merge_outputs


class SelfSupModelDepth_wofeedback(SfmModel_depth_wofeedback):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self._photometric_loss = MultiViewPhotometricLossRemap(**kwargs)
        #self._photometric_loss = MultiViewPhotometricLossCrossRemap(**kwargs)
    ...
    def self_supervised_loss(self, image, ref_images, inv_depths, poses,
                             intrinsics, prev_inv_depths , return_logs=False, progress=0.0):
        """
        ...
        return self._photometric_loss(
            image, ref_images, inv_depths, intrinsics, intrinsics, poses, prev_inv_depths,
    ...
    def forward(self, batch, return_logs=False, progress=0.0):
        ...
        if not self.training:
            ...
            self_sup_output = self.self_supervised_loss(
                ...
                output['inv_depths'], output['poses'], batch['intrinsics'], output['prev_inv_depths'],
                return_logs=return_logs, progress=progress)
