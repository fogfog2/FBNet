...
cfg.model.optimizer.depth.betas = (0.9,0.999)           # Depth learning rate
cfg.model.optimizer.depth.weight_decay = 0.0    # Dept weight decay
cfg.model.optimizer.depth2 = CN()
cfg.model.optimizer.depth2.lr = 0.0002           # Depth learning rate
cfg.model.optimizer.depth2.weight_decay = 0.0    # Dept weight decay
...
cfg.model.scheduler.gamma = 0.9         # Scheduler gamma value
...
cfg.model.loss.depth_reconstruction_weight = 0.05       # Smoothness loss weight
cfg.model.loss.depth_reconstruction_ssim_weight = 0.15       # Smoothness loss weight
...
cfg.model.depth_net.embed_dim = 96
cfg.model.depth_net.depths = [2,2,6,2]
cfg.model.depth_net.num_heads = [3,6,12,24]
cfg.model.depth_net.window_size = 7
cfg.model.depth_net.ape = False
cfg.model.depth_net.drop_path_rate = 0.3
cfg.model.depth_net.patch_norm = True
cfg.model.depth_net.use_checkpoint=False

########################################################################################################################
### MODEL.DEPTH_NET2
########################################################################################################################
cfg.model.depth_net2 = CN()
cfg.model.depth_net2.name = ''               # Depth network name
cfg.model.depth_net2.checkpoint_path = ''    # Depth checkpoint filepath
cfg.model.depth_net2.version = ''            # Depth network version
cfg.model.depth_net2.dropout = 0.0           # Depth network dropout
########################################################################################################################
### MODEL.POSE_NET
########################################################################################################################
